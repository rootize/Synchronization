...
for startid=1:1:1
   tracked_pts(startid)=loc_get_tracked_points(videoObj,startid,frag_length,p_surf_oct,p_surf_scl ,p_mv);
...
function s_tracked_pts=loc_get_tracked_points(videoObj,startid,frag_length,p_surf_oct,p_surf_scl ,p_mv)
...
[Px,Py]=loc_rm_static_points(Px,Py,p_mv);
...
function [Px,Py]=loc_rm_static_points(Px,Py,mv_pix)
